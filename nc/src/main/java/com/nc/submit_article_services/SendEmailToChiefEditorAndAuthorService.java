...
public class SendEmailToChiefEditorAndAuthorService implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		//mailService.sendMail("You have new atricle submitet to you magazine!", editor.getEmail());
		//mailService.sendMail("Your article has been submited succesfully!", author.getEmail());
